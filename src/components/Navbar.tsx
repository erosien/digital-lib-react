...
function Navbar() {
  ...
  return (
    <nav className='flex items-center justify-between flex-wrap bg-stone-500 p-6'>
        <div className='flex items-center flex-shrink-0 text-white mr-6'>
            <Link to='/' className='font-semibold text-xl tracking-tight'>My Books</Link>
        </div>
        <div className="block">
            <button 
                onClick={dropDown}
                className="flex items-center px-3 py-2 text-white 
                border rounded border-stone-200 hover:text-white hover:border-white">
        ...
        { isVisible ? (
            <div className="w-full block flex-grow items-center">
                <div className="text-sm lg:flex-grow">
                    <Button className="p-2 m-5 bg-stone-300 justify-center">
                        <div>
                            <Link to='/' onClick={ clicked } className="flex place-items-center mt-4 lg:inline-block lg:mt-0
                                 text-stone-500 hover:text-white mr-4">
                                Home
                            </Link>
                        </div>
                    </Button>
                        ...
                        <Button className='p-2 m-5 bg-stone-300 justify-center'>
                            <div>
                                <Link to="/" onClick={ () => { signInOnClick() }} className="flex place-items-center mt-4
                                     lg-inline-block lg:mt-0 text-stone-500 hover:text-white">
                                        Login
                                </Link>
                            </div>
                        </Button>
